...
const Contact = () => {
  ...
  return (
      <div className="mt-6 w-full  pl-[2%] max-lg:max-w-3xl mx-auto bg-[url(/images/cc.png)] ">
      <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4">
        <div>
          ...
          <p className="text-sm text-gray-300 mt-6 leading-relaxed">Have a project in mind or want to collaborate? Send me a message and I'll get back to you soon.</p>
          ...
          <ul className="flex mt-12 space-x-4">
            ...
            <li className="bg-[#a91079] hover:bg-[#a91079e2] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
              <a  href="https://www.linkedin.com/in/milot-verbani-4371232b1/" target="blank">
            ...
            <li className="bg-[#a91079] hover:bg-[#a91079e2] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
              <a href="https://www.instagram.com/milotverbanii/" target="blank">
                <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" fill='#fff'
                  viewBox="0 0 24 24">
                  <path
 ...
 <form ref={form}
        onSubmit={sendEmail} className="bg-white rounded-xl shadow-2xl p-8 sm:p-10 ">
                <div className="mb-8">
                    <h2 className="text-2xl font-semibold text-gray-800 border-b-2 border-primary-light pb-2 inline-block">Contact Form</h2>
                </div>
                ...
                <button type="submit" 
                    className="w-full cursor-pointer md:w-auto px-8 py-3 bg-gradient-to-r from-primary-light to-primary-dark text-blackss font-medium rounded-lg hover:from-primary-dark hover:to-primary-dark transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-primary-light focus:ring-opacity-50">
                    Send Message
                </button>
                {status && (
          <p
            className={`text-sm mt-4 ml-10 ${
